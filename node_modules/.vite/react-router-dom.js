import {
  _extends
} from "./chunk-KNJZEVSP.js";
import {
  require_react
} from "./chunk-DCN4YEXX.js";
import "./chunk-EMQ3SR5C.js";
import {
  __toModule,
...
function createHashHistory(b) {
  ...
  function z(a, f) {
    f === void 0 && (f = null);
    return C(_extends({ pathname: d.pathname, hash: "", search: "" }, typeof a === "string" ? J(a) : a, { state: f, key: H() }));
  }
  function A(a) {
    v = a;
    a = h();
